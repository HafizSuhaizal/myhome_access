      ...
      try {
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(
         // builder: (context) => EmergencyScreen(userEmail: '',),
          ...
          builder: (context) => PatrolReportScreen(userEmail: _emailController.text.trim()),
        ));
  ...
  void _handleLogin() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(
          builder: (context) =>MainMenuGuard(), //EmergencyScreen(userEmail: '',), //PatrolReportScreen(userEmail: _emailController.text.trim()),
        ));
      } on FirebaseAuthException catch (e) {
        setState(() {
          _errorMessage = e.message ?? 'Login failed';
