...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  Future<Map<String, dynamic>> _callPayEndpointMethodId({
    ...
    final url = Uri.parse(
      'https://us-central1-myhomeaccess-365ff.cloudfunctions.net/StripePayEndpointMethodId',
    );
  ...
  Future<Map<String, dynamic>> _callPayEndpointIntentId({
    ...
    final url = Uri.parse(
      'https://us-central1-myhomeaccess-365ff.cloudfunctions.net/StripePayEndpointIntentId',
    );
    final response = await http.post(
      url,
      headers: {'Content-Type': 'application/json'},
